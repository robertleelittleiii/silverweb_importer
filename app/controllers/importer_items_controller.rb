class ImporterItemsController < ApplicationController
  ...
  def create
    @importer_item = ImporterItem.new(importer_items_params)
  ...
  def update
    ...
    respond_to do |format|
      if @importer_item.update_attributes(importer_items_params)
  ...
  def importer_items_params
  params[:importer_items].permit( "importer_id", "from_column", "from_column_name", "to_column", "to_column_name", "created_at", "updated_at", "to_table_name", "from_table_name")
end
